...
func main() {
	...
	router.POST("/api/ingredient", mealHandler.CreateIngredient)
	router.POST("/api/recipe", mealHandler.CreateRecipe)
	router.GET("/api/recipe/:name", mealHandler.GetRecipeByName)
